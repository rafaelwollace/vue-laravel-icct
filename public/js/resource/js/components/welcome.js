...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "jumbotron text-center bg-transparent" }, [
      _c("h1", { staticClass: "display-4" }, [_vm._v("ICCT!")]),
      _vm._v(" "),
      _c("p", { staticClass: "lead" }, [_vm._v("CHALLENGE.")]),
      _vm._v(" "),
      _c("p", { staticClass: "lead" }, [
        _vm._v("DESENVOLVIDO COM LARAVEL, VUE.JS, MYSQL")
      ]),
      _vm._v(" "),
      _c("p", [
        _c(
